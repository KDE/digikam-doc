...
.. note::
    ...
    The native URLs selector dialog is only available if you turn on the right option from the :menuselection:`Settings --> Configure digiKam... --> Miscellaneous page --> Appearance tab`. See  :ref:`this section <appearance_settings>` of the manual for more details.
