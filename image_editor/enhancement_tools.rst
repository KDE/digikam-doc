...
| Preview                                             | Type                                                                                                                                                                 |
+-----------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| .. figure:: images/editor_refocus_notsharpened.webp | Original blurred color image to fix.                                                                                                                                 |
|    :width: 300px                                    | This image have been taken with an analog still camera.                                                                                                              |
|    :alt:                                            | The unfocusing result of an insufficient light for the auto-focus lens.                                                                                              |
|    :align: center                                   |                                                                                                                                                                      |
+-----------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| .. figure:: images/editor_refocus_sharped.webp      | Fixed image using simple sharpening filter.                                                                                                                          |
|    :width: 300px                                    | Sharpness setting is 80.                                                                                                                                             |
|    :alt:                                            |                                                                                                                                                                      |
|    :align: center                                   |                                                                                                                                                                      |
+-----------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| .. figure:: images/editor_refocus_unsharpmask.webp  | Fixed image using unsharp mask filter.                                                                                                                               |
|    :width: 300px                                    | Settings are Radius=50, Amount = 5, and Threshold=0.                                                                                                                 |
|    :alt:                                            |                                                                                                                                                                      |
|    :align: center                                   |                                                                                                                                                                      |
+-----------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| .. figure:: images/editor_refocus_refocus.webp      | Fixed image using Refocus filter.                                                                                                                                    |
|    :width: 300px                                    | Settings are Circular Sharpness=1.3, Correlation=0.5,                                                                                                                |
|    :alt:                                            | Noise Filter=0.020, Gaussian Sharpness=0 and Matrix Size=5.                                                                                                          |
|    :align: center                                   |                                                                                                                                                                      |
+-----------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------+
