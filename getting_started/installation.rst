...
.. note::
    ...
    - Under **Windows**, the **%_VariableName_%** indicate a `special folder <https://en.wikipedia.org/wiki/Special_folder#List_of_special_folders>`_ on the system generally pointing to a cached directory from the user space.
