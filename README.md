...
- The **script** section from [gitlab CI Yaml config file](.gitlab) where a new line must be add to genrate the new supported language in the Continuous Integration workflow.
